...
//        List<Double> allAdr = dao.getAllDpr();
...
//                }
//                else {
//                    points_tier_1 = ((allAdr.get(i) - parameters_tier_1.getMin_stat())
...
//                AdrPlayer adrPlayer_tier_1 = dao.getByAdrPlayer_Id_tier1(player_ids.get(i));
//                adrPlayer_tier_1.setPoints(points_tier_1_res);
//                adrPlayer_tier_1.setCoef_points(coef_points_tier_1_res);
...
//                }
//                else {
//                    points_tier_2 = ((allAdr.get(i) - parameters_tier_2.getMin_stat())
...
//                AdrPlayer adrPlayer_tier_2 = dao.getByAdrPlayer_Id_tier2(player_ids.get(i));
//                adrPlayer_tier_2.setPoints(points_tier_2_res);
//                adrPlayer_tier_2.setCoef_points(coef_points_tier_2_res);
