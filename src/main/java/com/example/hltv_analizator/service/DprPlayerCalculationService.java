...
//                }
//                else {
//                    points_tier_1 = 100 - (allDpr.get(i) - parameters_tier_1.getMax_stat())
//                            * parameters_tier_1.getPoints() / (parameters_tier_1.getMin_stat()
//                            - parameters_tier_1.getMax_stat());
//
...
//                DprPlayer dprPlayer_tier_1 = dao.getByDprPlayer_Id_tier1(player_ids.get(i));
//                dprPlayer_tier_1.setPoints(points_tier_1_res);
//                dprPlayer_tier_1.setCoef_points(coef_points_tier_1_res);
...
//                }
//                else {
//                    points_tier_2 = 100 - (allDpr.get(i) - parameters_tier_2.getMax_stat())
//                            * parameters_tier_2.getPoints() / (parameters_tier_2.getMin_stat()
//                            - parameters_tier_2.getMax_stat());
//
...
//                DprPlayer dprPlayer_tier_2 = dao.getByDprPlayer_Id_tier2(player_ids.get(i));
//                dprPlayer_tier_2.setPoints(points_tier_2_res);
//                dprPlayer_tier_2.setCoef_points(coef_points_tier_2_res);
